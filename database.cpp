...
Database::Database(QObject *parent) : QObject(parent){
    ...
    mainWinDB = QSqlDatabase::addDatabase("QSQLITE", "conn1-MainWinInfo");
...
void Database::getMainWinInfo(QString mwStatusF, QString mwlastFullScanF, QString mwLastSmartScanF, QString mwLastSingleScanF, QString mwLastUpdateF, QString mwThreatsFoundF, QString mwCurrentThreatsF){
    mwStatus =  mwStatusF;
